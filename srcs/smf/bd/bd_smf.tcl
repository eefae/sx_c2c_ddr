...
proc create_hier_cell_c2c_block { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 3 -to 0 axi_c2c_s2m_intr_out
  ...
  set_property -dict [list \
    CONFIG.C_AURORA_LANES {2} \
    CONFIG.C_LINE_RATE {5} \
    CONFIG.C_START_LANE {X0Y2} \
    CONFIG.C_START_QUAD {Quad_X0Y0} \
    CONFIG.C_USE_BYTESWAP {true} \
  ...
  connect_bd_intf_net -intf_net aurora_64b66b_0_USER_DATA_M_AXIS_RX [get_bd_intf_pins aurora_master/USER_DATA_M_AXIS_RX] [get_bd_intf_pins c2c_master/AXIS_RX]
  connect_bd_intf_net -intf_net aurora_64b66b_1_USER_DATA_M_AXIS_RX [get_bd_intf_pins aurora_slave/USER_DATA_M_AXIS_RX] [get_bd_intf_pins c2c_slave/AXIS_RX]
  ...
  connect_bd_intf_net -intf_net axi_chip2chip_0_AXIS_TX [get_bd_intf_pins aurora_master/USER_DATA_S_AXIS_TX] [get_bd_intf_pins c2c_master/AXIS_TX]
  connect_bd_intf_net -intf_net axi_chip2chip_1_AXIS_TX [get_bd_intf_pins aurora_slave/USER_DATA_S_AXIS_TX] [get_bd_intf_pins c2c_slave/AXIS_TX]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins c2c_master/s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins s_axi_lite] [get_bd_intf_pins c2c_master/s_axi_lite]
  connect_bd_intf_net -intf_net c2c_slave_m_axi [get_bd_intf_pins m_axi] [get_bd_intf_pins c2c_slave/m_axi]

  # Create port connections
  connect_bd_net -net aurora_master_channel_up [get_bd_pins axi_c2c_aurora_channel_up] [get_bd_pins aurora_master/channel_up] [get_bd_pins c2c_master/axi_c2c_aurora_channel_up]
  ...
  connect_bd_net -net aurora_slave_lane_up [get_bd_pins lane_up1] [get_bd_pins aurora_slave/lane_up]
  ...
  connect_bd_net -net c2c_master_axi_c2c_s2m_intr_out [get_bd_pins axi_c2c_s2m_intr_out] [get_bd_pins c2c_master/axi_c2c_s2m_intr_out]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_aclk] [get_bd_pins c2c_master/s_aclk] [get_bd_pins c2c_master/s_axi_lite_aclk] [get_bd_pins c2c_slave/m_aclk]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set C2C_MASTER_STATUS_LED [ create_bd_port -dir O C2C_MASTER_STATUS_LED ]
  set C2C_SLAVE_STATUS_LED [ create_bd_port -dir O C2C_SLAVE_STATUS_LED ]
...
\
  ...
  connect_bd_intf_net -intf_net GT_SERIAL_RX_0_1 [get_bd_intf_ports GT_AURORA_SLAVE_RX] [get_bd_intf_pins c2c_block/aur_slave_rx]
  connect_bd_intf_net -intf_net GT_SERIAL_RX_1_1 [get_bd_intf_ports GT_AURORA_MASTER_RX] [get_bd_intf_pins c2c_block/aur_master_rx]
  connect_bd_intf_net -intf_net aurora_master_GT_SERIAL_TX [get_bd_intf_ports GT_AURORA_MASTER_TX] [get_bd_intf_pins c2c_block/aur_master_tx]
  connect_bd_intf_net -intf_net aurora_slave_GT_SERIAL_TX [get_bd_intf_ports GT_AURORA_SLAVE_TX] [get_bd_intf_pins c2c_block/aur_slave_tx]
  connect_bd_intf_net -intf_net c2c_block_m_axi [get_bd_intf_pins c2c_block/m_axi] [get_bd_intf_pins smartconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins c2c_block/s_axi] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins c2c_block/s_axi_lite] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net c2c_master_axi_c2c_link_status_out [get_bd_ports C2C_MASTER_STATUS_LED] [get_bd_pins c2c_block/axi_c2c_link_status_out1] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net c2c_master_axi_c2c_s2m_intr_out [get_bd_pins c2c_block/axi_c2c_s2m_intr_out] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net c2c_slave_axi_c2c_link_status_out [get_bd_ports C2C_SLAVE_STATUS_LED] [get_bd_pins c2c_block/axi_c2c_link_status_out] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net clk_wiz_0_clk_50M [get_bd_pins c2c_block/init_clk] [get_bd_pins clk_wiz_0/clk_50M]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins c2c_block/s_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins c2c_block/s_aclk] [get_bd_pins clk_wiz_0/clk_100M] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x001000000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs c2c_block/c2c_master/s_axi/Mem0] -force
  assign_bd_address -offset 0xA0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs c2c_block/c2c_master/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces c2c_block/c2c_slave/MAXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces c2c_block/c2c_slave/MAXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces c2c_block/c2c_slave/MAXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.543202",
   "Default View_TopLeft":"458,-249",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port CLK_125 -pg 1 -lvl 0 -x -30 -y 250 -defaultsOSRD
preplace port GT_AURORA_REFCLK -pg 1 -lvl 0 -x -30 -y -260 -defaultsOSRD
preplace port port-id_C2C_MASTER_STATUS_LED -pg 1 -lvl 9 -x 3060 -y 30 -defaultsOSRD
preplace port port-id_C2C_SLAVE_STATUS_LED -pg 1 -lvl 9 -x 3060 -y 60 -defaultsOSRD
preplace port GT_AURORA_MASTER_RX -pg 1 -lvl 0 -x -30 -y -190 -defaultsOSRD
preplace port GT_AURORA_SLAVE_RX -pg 1 -lvl 0 -x -30 -y -150 -defaultsOSRD
preplace port GT_AURORA_MASTER_TX -pg 1 -lvl 9 -x 3060 -y -190 -defaultsOSRD
preplace port GT_AURORA_SLAVE_TX -pg 1 -lvl 9 -x 3060 -y -170 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 8 -x 2610 -y 310 -defaultsOSRD
preplace inst c2c_block -pg 1 -lvl 6 -x 1750 -y -120 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 3 -x 630 -y 250 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 4 -x 930 -y 350 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 7 -x 2260 -y 140 -defaultsOSRD
preplace inst smartconnect_1 -pg 1 -lvl 5 -x 1270 -y 80 -defaultsOSRD
preplace inst util_ds_buf_0 -pg 1 -lvl 1 -x 120 -y 250 -defaultsOSRD
preplace inst util_ds_buf_1 -pg 1 -lvl 2 -x 390 -y 250 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 8 -x 2610 -y 120 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 6 -x 1750 -y 110 -defaultsOSRD
preplace netloc c2c_master_axi_c2c_link_status_out 1 6 3 N -30 2420 30 N
preplace netloc c2c_master_axi_c2c_s2m_intr_out 1 5 2 1430 210 2070J
preplace netloc c2c_slave_axi_c2c_link_status_out 1 6 3 N -130 2430 50 2750
preplace netloc clk_wiz_0_clk_50M 1 3 3 730J -50 NJ -50 NJ
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 4 4 1120 170 1420J 220 2100 300 2410
preplace netloc util_ds_buf_0_IBUF_OUT 1 1 1 NJ 250
preplace netloc util_ds_buf_1_BUFG_O 1 2 1 NJ 250
preplace netloc xlconcat_0_dout 1 8 1 2750 120n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 3 5 740 160 1110 160 1410 230 2090 310 N
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 3 4 750 240 NJ 240 NJ 240 2060
preplace netloc CLK_125_1 1 0 1 NJ 250
preplace netloc GT_DIFF_REFCLK1_0_1 1 0 6 NJ -260 NJ -260 NJ -260 NJ -260 NJ -260 1410J
preplace netloc GT_SERIAL_RX_0_1 1 0 6 NJ -150 NJ -150 NJ -150 NJ -150 NJ -150 NJ
preplace netloc GT_SERIAL_RX_1_1 1 0 6 NJ -190 NJ -190 NJ -190 NJ -190 NJ -190 NJ
preplace netloc aurora_master_GT_SERIAL_TX 1 6 3 N -190 N -190 NJ
preplace netloc aurora_slave_GT_SERIAL_TX 1 6 3 N -170 N -170 NJ
preplace netloc c2c_block_m_axi 1 4 3 1130 200 NJ 200 2080J
preplace netloc smartconnect_0_M00_AXI 1 5 3 1430 20 N 20 2400
preplace netloc smartconnect_0_M01_AXI 1 5 3 1420 -270 N -270 2410
preplace netloc smartconnect_0_M02_AXI 1 7 1 2420 160n
preplace netloc smartconnect_1_M00_AXI 1 5 1 N 80
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 6 1 2100 80n
levelinfo -pg 1 -30 120 390 630 930 1270 1750 2260 2610 3060
pagesize -pg 1 -db -bbox -sgen -230 -280 3310 660
"
}
